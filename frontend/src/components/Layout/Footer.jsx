        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/giftwizard"
                target="_blank"
              ...
              <a
                href="https://twitter.com/giftwizard"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="mailto:support@giftwizard.com"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Email"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:support@giftwizard.com" className="hover:text-white">
                  support@giftwizard.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Получайте лучшие идеи подарков первыми!
            </p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="Ваш email"
                className="w-full px-3 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              <button
                type="submit"
