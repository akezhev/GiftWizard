...
const CookieConsent = ({ onAccept, onDecline }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900 text-white p-4 z-50 animate-slideUp">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-purple-600 rounded-lg hover:bg-purple-700 transition-colors"
          >
            Принять
          </button>
        </div>
        <button
          ...
          className="absolute top-4 right-4 md:relative md:top-auto md:right-auto text-gray-400 hover:text-white"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
